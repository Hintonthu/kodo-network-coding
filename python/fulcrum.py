...
def main():
    ...
    encoder_factory = kodo.FulcrumEncoderFactoryBinary(symbols, symbol_size)
    decoder_factory = kodo.FulcrumDecoderFactoryBinary(symbols, symbol_size)
    ...
    decoder_factory.set_expansion(new_expansion)
    ...
    if data_out == data_in:
        print("Data decoded correctly: {}".format(binascii.hexlify(data_in)))
    else:
