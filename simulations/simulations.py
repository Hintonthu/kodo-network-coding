...
def relay_simulation(symbols,
    ...
    channel1 = s.create_channel(channel_condition=error_source_sink)
    channel2 = s.create_channel(channel_condition=error_source_sink)
    channel3 = s.create_channel(channel_condition=error_source_sink)
    s.connect(channel=channel1, a=source, b=sink)
    s.connect(channel=channel2, a=source, b=sink)
    s.connect(channel=channel3, a=source, b=sink)
